...
import { getFaturamentoComparativo } from '@/lib/postgres/faturamentoPorEmpresa';
...
export async function GET() {
  ...
  const resultado = await getFaturamentoComparativo(['construmix', 'sams', 'newhouse'], ultimosMeses(6));
