 ...
 * manualmente (tela Gestão > Faturamento) até o conector Firebird da
 * Construmix (lib/firebird/construmixFaturamento.ts) ser ligado a um
 * relatório real e passar a gravar aqui via `origem = 'zeus-sync'`.
 */
